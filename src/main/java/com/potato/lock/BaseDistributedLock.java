...
public class BaseDistributedLock {
    ...
    private void checkAndCreate(ZkClient client,  String path) throws Exception{

        Boolean  isExists=client.exists(path);
        if(!isExists) {
    ...
    private boolean waitToLock(long startMillis, Long millisToWait, String ourPath) throws Exception{
        ...
        try{
            while ( !haveTheLock ) {
                ...
                System.out.println(ourPath+" index is "+ourIndex);
    ...
    protected String attemptLock(long time, TimeUnit unit) throws Exception {
        ...
        checkAndCreate(client,basePath);
